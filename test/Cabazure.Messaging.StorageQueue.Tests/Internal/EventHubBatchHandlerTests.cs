...
public class StorageQueueBatchHandlerTests
{
    ...
    public async Task ProcessBatchAsync_Should_Call_Processor_For_Each_Message(
        ...
        StorageQueueHandler<TMessage, TProcessor> sut,
        EventData[] data,
        TMessage[] messages,
        ...
        CancellationToken cancellationToken)
    {
        ...
        var expectedMetadata = data
            .Select(e => StorageQueueMetadata.Create(e, partition.PartitionId))
            .ToArray();
        processor
    ...
    public async Task ProcessBatchAsync_Should_Not_Call_Processor_When_Filter_Does_Not_Match(
        ...
        [Frozen, NoAutoProperties] JsonSerializerOptions serializerOptions,
        [Frozen] List<Func<IDictionary<string, object>, bool>> filters,
        StorageQueueBatchHandler<TMessage, TProcessor> sut,
        EventData data,
        TMessage message,
        EventProcessorPartition partition,
        string propertyKey,
        ...
        CancellationToken cancellationToken)
    {
        ...
        processor
            .ReceivedCallWithArgument<StorageQueueMetadata>()
            .Should()
            .BeEquivalentTo(
                StorageQueueMetadata.Create(data, partition.PartitionId));
    }
    ...
    public async Task ProcessErrorAsync_Should_Call_Processor(
        ...
        [Frozen, NoAutoProperties] JsonSerializerOptions serializerOptions,
        [Frozen] List<Func<IDictionary<string, object>, bool>> filters,
        StorageQueueBatchHandler<TMessage, TProcessorWithErrorHandling> sut,
        Exception exception,
        CancellationToken cancellationToken)
    {
        await sut.ProcessErrorAsync(
